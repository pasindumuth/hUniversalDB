...
test1 = do
  SM.addClientMsg (SM.mkClientEId 0) (SM.mkSlaveEId 0 0) (CRq.RangeWrite [Co.KeySpaceRange (Co.Path "t")] 1); SM.simulateNms 2
  SM.addClientMsg (SM.mkClientEId 0) (SM.mkSlaveEId 0 1) (CRq.SlaveWrite (Co.Path "t") "key1" "value1" 2); SM.simulateNms 2
  SM.addClientMsg (SM.mkClientEId 0) (SM.mkSlaveEId 0 2) (CRq.SlaveWrite (Co.Path "t") "key2" "value2" 3); SM.simulateNms 2
  SM.addClientMsg (SM.mkClientEId 0) (SM.mkSlaveEId 0 3) (CRq.SlaveWrite (Co.Path "t") "key3" "value3" 4); SM.simulateNms 2
  SM.addClientMsg (SM.mkClientEId 0) (SM.mkSlaveEId 0 4) (CRq.SlaveWrite (Co.Path "t") "key4" "value4" 5); SM.simulateNms 2
  SM.addClientMsg (SM.mkClientEId 0) (SM.mkSlaveEId 0 0) (CRq.SlaveWrite (Co.Path "t") "key5" "value5" 6); SM.simulateAll
...
test4 = do
  SM.addClientMsg (SM.mkClientEId 0) (SM.mkMasterEId 0) (CRq.CreateDatabase (Co.Path "t") 1); SM.simulateAll
  SM.addClientMsg (SM.mkClientEId 0) (SM.mkMasterEId 0) (CRq.CreateDatabase (Co.Path "t") 2); SM.simulateNms 2
  SM.addClientMsg (SM.mkClientEId 0) (SM.mkSlaveEId 0 0) (CRq.SlaveWrite (Co.Path "t") "key1" "value1" 3); SM.simulateNms 2
  SM.addClientMsg (SM.mkClientEId 0) (SM.mkSlaveEId 0 1) (CRq.SlaveWrite (Co.Path "t") "key2" "value2" 4); SM.simulateNms 2
  SM.addClientMsg (SM.mkClientEId 0) (SM.mkSlaveEId 0 2) (CRq.SlaveWrite (Co.Path "t") "key3" "value3" 5); SM.simulateNms 2
  SM.addClientMsg (SM.mkClientEId 0) (SM.mkSlaveEId 0 3) (CRq.SlaveWrite (Co.Path "t") "key4" "value4" 6); SM.simulateNms 2
  SM.addClientMsg (SM.mkClientEId 0) (SM.mkSlaveEId 0 4) (CRq.SlaveWrite (Co.Path "t") "key5" "value5" 7); SM.simulateAll
...
test7 = do
  SM.addClientMsg (SM.mkClientEId 0) (SM.mkMasterEId 0) (CRq.CreateDatabase (Co.Path "t1") 1); SM.simulateAll
  SM.addClientMsg (SM.mkClientEId 0) (SM.mkMasterEId 0) (CRq.CreateDatabase (Co.Path "t1") 2); SM.simulateAll
  SM.addClientMsg (SM.mkClientEId 0) (SM.mkMasterEId 0) (CRq.DeleteDatabase (Co.Path "t1") 3); SM.simulateAll
  SM.addClientMsg (SM.mkClientEId 0) (SM.mkMasterEId 0) (CRq.CreateDatabase (Co.Path "t2") 4); SM.simulateAll
  SM.addClientMsg (SM.mkClientEId 0) (SM.mkSlaveEId 0 0) (CRq.SlaveWrite (Co.Path "t2") "key1" "value1" 5); SM.simulateNms 2
  SM.addClientMsg (SM.mkClientEId 0) (SM.mkSlaveEId 0 1) (CRq.SlaveWrite (Co.Path "t2") "key1" "value2" 6); SM.simulateNms 2
  SM.addClientMsg (SM.mkClientEId 0) (SM.mkSlaveEId 0 2) (CRq.SlaveRead (Co.Path "t2") "key1" 7); SM.simulateAll
